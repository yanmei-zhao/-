...
public class UUIDLocker {

	/**
	 * 3-DES加密
	 * @param String
	 *            src为要进行3-DES加密的String
	 * @param String
	 *            spkey为分配的SPKEY
	...
	public static String get3DESEncrypt(String src, String spkey) {
		...
		try {
			...
			//e.printStackTrace();
			System.out.println("3-DES加密出错： "+e);
		}
	 ...
	 * 提示"p验证失败"。在开发的过程中，因为这个问题让我束手无策， 一个朋友告诉我可以问联通要一段加密后 的文字，然后去和自己生成的字符串比较，
	...
	public static void main(String[] args) {
		UUIDLocker test = new UUIDLocker();
		UUID uuid = UUID.randomUUID();
		//String oldString = uuid.toString();
		String oldString = "bbb2e280-45a4-4960-b6f8-d7fffbfa3ed4";
		System.out.println("oldString=="+oldString);

		String SPKEY = SystemContext.QRCODE_SPKEY;
		System.out.println("1。分配的SPKEY为:  " + SPKEY);
		System.out.println("2。加密的内容为:  " + oldString);
