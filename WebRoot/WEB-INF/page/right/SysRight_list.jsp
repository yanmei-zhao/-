...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		$(".tip").fadeOut(100);
		window.location.href="<%= basePath%>/front/SysRight_delete.action?rightId="+rightId;
	});
...
<body>
    ...
    <li><a href="#">权限管理</a></li>
    <li><a href="<%= basePath%>/front/SysRight_list.action">权限列表</a></li>
    </ul>
    </div>
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
    	...
    	<ul class="seachform">
            ...
            <li class="clickk"><span><img src="<%=path%>/images/t01.png" /></span><a href="<%= basePath%>/front/SysRight_openAdd.action">添加</a></li>
    ...
    <!-- 分页菜单组件--------------------------开始 -->
<%
//查询的url地址，统一写front/SysRight_list.action";
String listActionURL = basePath+"/front/SysRight_list.action";
%>
...
<script type="text/javascript">
var url = "<%= basePath%>/front/SysRight_list.action";                 //获取表单url
//首页
function first(){
