...
<body>
    ...
    <li><label>参加人数</label><input name="admin.totalPeople" id="totalPeople" type="text" readonly="ture" class="dfinput"  value="<s:property value="totalPeople"/>"/></li>
 <li>  <a href="<%=basePath%>/front/Admin_update.action?examId=${examId}"> 通过</a>&nbsp;&nbsp;
