...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
     	...
     	<form action="<%= basePath%>/front/FillTopic_list.action" method="post"  target="rightFrame" autocomplete="off">
    	<ul class="seachform">
    	    <li><label>综合查询</label><input class="scinput1" name="fillTopic.description"  placeholder="请输入试题关键词"></li>
    	     <li><label>所属题库</label>
	           <select name="fillTopic.topicBankName" id="choiceTopic.topicBankName" onchange="selectValue(this)"  class="scinput1" >
	            	<option> </option>
		     ...
		     <li><label>试题难度</label>
		         <select name="fillTopic.difficulty" id="difficulty" onchange="selectValue(this)"  class="scinput1">
		              <option>非常容易</option>
		              <option>比较容易</option>
