...
<head>
	...
	<script type="text/javascript">
		...
		$(".sure").click(function(){
			$(".tip").fadeOut(100);
			window.location.href="<%= basePath%>/front/Teacher_delete.action?teacherId="+teacherId;
		});
	...
	<script type="text/javascript">
		$(function(){
			$("#import").upload({
				action:'<%=basePath%>/front/Teacher_importXls.action',
				name:'myFile',
	...
	<script type="text/javascript">
		function doExport(){
		window.location.href = "<%= basePath%>/front/Teacher_exportXls.action";
		}
		function doTemplateExport(){
		window.location.href = "<%= basePath%>/front/Teacher_exportTemplateXls.action";
		}
	</script>
...
<body>
	<div class="place">
	   ...
	   <li><a href="<%=basePath%>/front/Login_openIndex.action" target="rightFrame">首页</a></li>
	    <li><a href="#">用户管理</a></li>
	    <li><a href="<%= basePath%>/front/Student_list.action">教师列表</a></li>
	    </ul>
    </div>
	<div class="formbody">
	    <div id="usual1" class="usual">
	      <div id="tab2" class="tabson">
	    	...
	    	<ul class="seachform">
	            ...
	            <li class="clickk"><span><img src="<%=path%>/images/t01.png" /></span><a href="<%= basePath%>/front/Teacher_openAdd.action">添加</a></li>
		    ...
		    <table class="tablelist">
		        ...
		        <tbody>
			        <s:iterator value="pageResult.data" id="id">
				        <tr>
				        <td><input name="checkbox" type="checkbox" value='<s:property value="teacherId"/>' /></td>
				        <td>${teacherId}</td>
				        <td>${teacherName}</td>
				        <td>
	...
	<%
	//查询的url地址，统一写
	String listActionURL = basePath+"/front/Teacher_list.action";
	%>
	...
	<script type="text/javascript">
		var url = "<%= basePath%>/front/Teacher_list.action";                 //获取表单url
		//首页
		function first(){
